...
* `NDVI_explorer_V2.py`: Simpel script wat een subset van de data plot voor inspecit en validatie.
* `NDVI_Histogram`: Telt hoe vaak elke individuele meetwaarde (in het bereik 0-200) voorkomt en plot die uit in een histogram.
* `NDVI_jenks_V2`: Past het Fisher-Jenks algorithme voor natural breaks to op de data en berekent de optimale grenswaardes voor het classificeren naar 2-10 groepen.
